...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js?parser=sugarss!./style.sss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js?parser=sugarss!./style.sss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\n  background: #556270;; /* fallback for old browsers */\n  background: -webkit-linear-gradient(to left, #556270 , #FF6B6B);; /* Chrome 10-25, Safari 5.1-6 */\n  background: -webkit-linear-gradient(right, #556270 , #FF6B6B);;\n  background: linear-gradient(to left, #556270 , #FF6B6B); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */\n}\n\n\nbody:before { /* fallback for old browsers */ /* Chrome 10-25, Safari 5.1-6 */ /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */\n  content: '';\n  display: table\n}\n\n\nbody:after { /* fallback for old browsers */ /* Chrome 10-25, Safari 5.1-6 */ /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */\n  content: '';\n  display: table;\n  clear: both\n}\n\n\nbody *:not(input):not(textarea):not(select) { /* fallback for old browsers */ /* Chrome 10-25, Safari 5.1-6 */ /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */\n  background-color: rgba(0, 0, 255, 0.1)\n}\n\n\n.container {\n  margin: 20px 0 20px 0\n}\n\n\n.results {\n  /*padding: 5px */\n  width: calc(99.9% * 9/12 - (30px - 30px * 9/12));\n  font-family: 'Playfair Display',serif;\n  margin-bottom: 20px;\n  background-color: transparent;\n  /*font-size: responsive */\n  overflow-y: auto;\n  height: 100%\n}\n\n\n.results:nth-child(1n) { /*padding: 5px */ /*font-size: responsive */\n  float: left;\n  margin-right: 30px;\n  clear: none\n}\n\n\n.results:last-child { /*padding: 5px */ /*font-size: responsive */\n  margin-right: 0\n}\n\n\n.results:nth-child(12n) { /*padding: 5px */ /*font-size: responsive */\n  margin-right: 0;\n  float: right\n}\n\n\n.results:nth-child(12n + 1) { /*padding: 5px */ /*font-size: responsive */\n  clear: both\n}\n\n.right {\n  width: calc(99.9% * 3/12 - (30px - 30px * 3/12));\n  background-color: transparent;\n  font-family: 'Playfair Display',serif;\n  margin-bottom: 20px;\n  height: 100%\n  /*height: 100% */\n  /*lost-center: flex */\n  /*lost-align: top-center */\n}\n\n.right:nth-child(1n) { /*height: 100% */ /*lost-center: flex */ /*lost-align: top-center */\n  float: left;\n  margin-right: 30px;\n  clear: none\n}\n\n.right:last-child { /*height: 100% */ /*lost-center: flex */ /*lost-align: top-center */\n  margin-right: 0\n}\n\n.right:nth-child(12n) { /*height: 100% */ /*lost-center: flex */ /*lost-align: top-center */\n  margin-right: 0;\n  float: right\n}\n\n.right:nth-child(12n + 1) { /*height: 100% */ /*lost-center: flex */ /*lost-align: top-center */\n  clear: both\n}\n\nh1#title {\n  font-family: 'Playfair Display',serif;\n  font-size: 42;\n  position: relative;\n  /*lost-center: flex */\n  text-align: center;\n  margin: 0 auto\n  /*margin: 0 auto */\n  /*width: 100% */\n  /*margin-top: 5px */\n  /*font-size: responsive */\n}\n\nh1#title > * { /*lost-center: flex */ /*margin: 0 auto */ /*width: 100% */ /*margin-top: 5px */ /*font-size: responsive */\n  position: absolute;\n  top: 0;\n  right: auto;\n  bottom: auto;\n  left: 50%;\n  transform: translate(-50%, 0)\n}\n\na:link {\n  text-decoration: none;\n  color: grey;\n  background-color: white;\n  border-width: 0;\n  border-color: grey\n}\n\ninput#searchbox {\n  top: 0;\n  right: 0;\n  border-width: 5px;\n  border-radius: 25px;\n  border-color: black;\n  outline: 0;\n  background: #dcddd8;\n  width: 100%;\n  height: 50px;\n  margin: 0;\n  padding: 0px 55px 0px 20px;\n  font-size: 15px;\n  color: red;\n  font-family: 'Playfair Display',serif\n}\n\nbutton {\n  font-family: 'Playfair Display',serif;\n  display: flex;\n  flex-flow: row wrap;\n  max-width: flex;\n  margin-left: auto;\n  margin-right: auto;\n  margin-top: 21px;\n  padding: 0.5em 1em;\n  border-radius: 4px\n}\n\nh3 {\n  font-style: bold;\n  padding-left: 5px\n}\n\n\np {\n  font-style: italic;\n  font-size: 1em;\n  padding-left: 5px;\n  padding-right: 5px\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(document).ready(function () {
	  (0, _jquery2.default)("#searchbox").keypress(function (event) {
	    if (event.which === 13) {
	      search((0, _jquery2.default)("#searchbox").val());
	    }
	  });
	});
