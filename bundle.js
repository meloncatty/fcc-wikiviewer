...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\n  /*lost-utility: edit */\n  background: #E8C386; /* fallback for old browsers */\n}\n\n\nbody:before {\n  /*lost-utility: edit */\n  /* fallback for old browsers */\n  content: '';\n  display: table\n}\n\n\nbody:after {\n  /*lost-utility: edit */\n  /* fallback for old browsers */\n  content: '';\n  display: table;\n  clear: both\n}\n\n\n.container {\n  margin: 20px 0 20px 0\n}\n\n\n.results {\n  /*padding: 5px */\n  width: calc(99.9% * 9/12 - (30px - 30px * 9/12));\n  font-family: 'Playfair Display',serif;\n  margin-bottom: 20px;\n  background-color: transparent;\n  /*font-size: responsive */\n  overflow-y: auto;\n  height: 100%\n}\n\n\n.results:nth-child(1n) {\n  /*padding: 5px */\n  /*font-size: responsive */\n  float: left;\n  margin-right: 30px;\n  clear: none\n}\n\n\n.results:last-child {\n  /*padding: 5px */\n  /*font-size: responsive */\n  margin-right: 0\n}\n\n\n.results:nth-child(12n) {\n  /*padding: 5px */\n  /*font-size: responsive */\n  margin-right: 0;\n  float: right\n}\n\n\n.results:nth-child(12n + 1) {\n  /*padding: 5px */\n  /*font-size: responsive */\n  clear: both\n}\n\n.myFPC {\n  border-radius: 10px;\n  border-width: 1px;\n  border-color: black;\n  border-style: solid;\n  margin-bottom: 5px;\n  background: #DCDDD8;\n  margin-left: 30px\n}\n\n\n\n\n.right {\n  width: calc(99.9% * 3/12 - (30px - 30px * 3/12));\n  background-color: transparent;\n  font-family: 'Playfair Display',serif;\n  margin-bottom: 20px;\n  height: 100%\n  /*height: 100% */\n  /*lost-center: flex */\n  /*lost-align: top-center */\n}\n\n\n\n\n.right:nth-child(1n) {\n  /*height: 100% */\n  /*lost-center: flex */\n  /*lost-align: top-center */\n  float: left;\n  margin-right: 30px;\n  clear: none\n}\n\n\n\n\n.right:last-child {\n  /*height: 100% */\n  /*lost-center: flex */\n  /*lost-align: top-center */\n  margin-right: 0\n}\n\n\n\n\n.right:nth-child(12n) {\n  /*height: 100% */\n  /*lost-center: flex */\n  /*lost-align: top-center */\n  margin-right: 0;\n  float: right\n}\n\n\n\n\n.right:nth-child(12n + 1) {\n  /*height: 100% */\n  /*lost-center: flex */\n  /*lost-align: top-center */\n  clear: both\n}\n\nh1#title {\n  font-family: 'Playfair Display',serif;\n  font-size: 42;\n  position: relative;\n  /*lost-center: flex */\n  text-align: center;\n  margin: 0 auto\n  /*margin: 0 auto */\n  /*width: 100% */\n  /*margin-top: 5px */\n  /*font-size: responsive */\n}\n\nh1#title > * {\n  /*lost-center: flex */\n  /*margin: 0 auto */\n  /*width: 100% */\n  /*margin-top: 5px */\n  /*font-size: responsive */\n  position: absolute;\n  top: 0;\n  right: auto;\n  bottom: auto;\n  left: 50%;\n  transform: translate(-50%, 0)\n}\n\na:link {\n  text-decoration: none;\n  color: #E8B979;\n  background-color: none\n}\n\n\ninput#searchbox {\n  top: 0;\n  right: 0;\n  border-width: 5px;\n  border-radius: 25px;\n  border-color: black;\n  outline: 0;\n  background: #dcddd8;\n  width: 100%;\n  height: 50px;\n  margin: 0;\n  padding: 0px 55px 0px 20px;\n  font-size: 15px;\n  color: #000;\n  font-family: 'Playfair Display',serif\n}\n\nbutton {\n  font-family: 'Playfair Display',serif;\n  display: flex;\n  flex-flow: row wrap;\n  max-width: flex;\n  margin-left: auto;\n  margin-right: auto;\n  margin-top: 21px;\n  padding: 0.5em 1em;\n  border-radius: 4px;\n  background: #E8B96B;\n  color: #dcddd8;\n  border: 1px solid #E8B96B;\n  box-shadow: 0 4px 0px #E8B979\n}\n\nh3 {\n  font-style: bold;\n  padding-left: 5px;\n  border-radius: 10px;\n  margin-top: 8px;\n  margin-bottom: 8px\n}\n\n\np {\n  font-size: 1em;\n  padding-left: 5px;\n  padding-right: 5px;\n  border-radius: 10px;\n  margin-top: 8px;\n  margin-bottom: 8px\n}\n\nhr {\n  border: 1px solid #000\n}\n", ""]);
	  ...
	  _jquery2.default.ajax({
	    ...
	    success: function success(data) {
	      ...
	      for (var i = 0; i < data[1].length; i++) {
	        //$()
	        (0, _jquery2.default)('.results').append('<div class = "myFPC" id="' + i + '">');
	        (0, _jquery2.default)("#" + i).append("<h3 class=\"" + i + "\">" + data[1][i] + "</h3>");
	        (0, _jquery2.default)("#" + i).append("<p class=\"" + i + "\">" + data[2][i] + "</p>");
